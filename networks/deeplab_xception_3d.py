...
class DeepLabv3_plus_3d(nn.Module):
    def __init__(self, nInputChannels=3, n_classes=21, os=16, pretrained=False, _print=True, final_sigmoid=False,
        ...
        super(DeepLabv3_plus_3d, self).__init__()
    ...
    def train_fixbn(self, mode=True, freeze_bn=True, freeze_bn_affine=False):
        ...
        Returns:
            Module: self
        """
        super(DeepLabv3_plus_3d, self).train(mode)
        if freeze_bn:
...
if __name__ == "__main__":
    ...
    model = DeepLabv3_plus_3d(nInputChannels=3, n_classes=21, os=16, pretrained=False, _print=True)
