...
def create_conv(in_channels, out_channels, kernel_size, order, num_groups, padding=1):
    ...
    for i, char in enumerate(order):
        if char == 'r':
            ...
            # modules.append(('conv_xy', conv3d(in_channels, out_channels, (1, kernel_size, kernel_size), bias, padding=(0,padding,padding))))
            # modules.append(('conv_z', conv3d(out_channels, out_channels, (kernel_size, 1, 1), bias, padding=(padding,0,0))))
        elif char == 'g':
...
class Decoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3,
        ...
        if basic_module == DoubleConv:
            ...
            # self.upsample2 = nn.ConvTranspose3d(in_channels,
            #                                     out_channels,
            #                                     kernel_size=(1, kernel_size, kernel_size),
            #                                     stride=scale_factor,
            #                                     padding=(0, 0, 1),
            ...
            #
            # self.upsample3 = nn.ConvTranspose3d(in_channels,
            #                                     out_channels,
            #                                     kernel_size=(1, kernel_size, kernel_size),
            #                                     stride=scale_factor,
            #                                     padding=(0, 1, 0),
            ...
            #
            # self.upsample4 = nn.ConvTranspose3d(in_channels,
            #                                     out_channels,
            #                                     kernel_size=(1, kernel_size, kernel_size),
            #                                     stride=scale_factor,
            #                                     padding=(0, 1, 1),
    ...
    def forward(self, encoder_features, x):
        if self.upsample is None:
            ...
            #
            # if o_h == (i_h * 2 + 1) and o_w == (i_w * 2 + 1):
            #     x = self.upsample(x)
            # elif o_h == (i_h * 2 + 1) and o_w == (i_w * 2):
            #     x = self.upsample2(x)
            # elif o_h == (i_h * 2) and o_w == (i_w * 2 + 1):
            #     x = self.upsample3
            # elif o_h == (i_h * 2) and o_w == (i_w * 2):
            #     x = self.upsample4(x)
