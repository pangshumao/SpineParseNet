...
class DeepLabv3_plus_skipconnection_2d(nn.Module):
    def __init__(self, nInputChannels=3, n_classes=21, os=16, pretrained=False, _print=True, final_sigmoid=False,
        ...
        # self.feature_projection_conv2 = nn.Conv2d(16, 32, 1, bias=False)
        # if normalization == 'bn':
        #     self.feature_projection_bn2 = nn.BatchNorm2d(32)
        # elif normalization == 'gn':
...
if __name__ == "__main__":
    ...
    model = DeepLabv3_plus_skipconnection_2d(nInputChannels=3, n_classes=21, os=16, pretrained=False, _print=True)
