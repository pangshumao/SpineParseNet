...
if __name__ == '__main__':
    ...
    parser.add_argument("--stage", type=str, default='coarse_fine',
                        help="fine or coarse")
    ...
    maskDir = os.path.join(dataDir, 'fine', 'in/nii/mask')
    if args.coarse_identifier != 'DeepLabv3_plus_gcn_skipconnection_3d_gcn_mode_2_ds_weight_0.3_loss_' \
                                 'CrossEntropyLoss_Adam_lr_0.001_pretrained' and stage == 'coarse_fine':
